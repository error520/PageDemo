...
import com.kinco.kmlink.ui.settingpage.SettingCategoryFragment;
import com.kinco.kmlink.ui.readpage.ReadCategoryFragment;
...
import com.kinco.kmlink.ui.oscpage.OscFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    private OscFragment thirdpageFragment = new OscFragment();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //此函数会判断是不是从外部打开wave文件进来的, 进而决定是否切换页面
        showWave(getIntent());
...
//            }
        ...
        rightLayout.setOnClickListener(v -> {
            if (deviceList == null) {
                deviceList = new DeviceWindow(MainActivity.this);
            }
