...
public class FileAdapter extends BaseAdapter {
    ...
    private String mAuthority = "com.kinco.kmlink.fileprovider";
    ...
    private File getFile(int pos){
        File file = new File(FileUtil.waveDir+File.separator+fileList.get(pos));
