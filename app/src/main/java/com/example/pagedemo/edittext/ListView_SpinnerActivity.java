...
public class ListView_SpinnerActivity extends Activity {
    ...
    String[][] temp = {{"0：Vector control without PG","1: Vector control with PG","2:V/F control"},
            ...
            {"0:Running signal(RUN)",
                    ...
                    "5:low voltage signal(LU) 6:external fault signal(EXT",
                    "7:frequency high limit(FHL) 8:frequency low limit(FLL) 9:zero-speed running ",
                    "10:Terminal X1(Reserved) 11:Terminal X2(Reserved)",
                    "12:PLC running step complete signal",
                    "13:PLC\trunning\tcycle\tcompletesignal",
                    "14:Limit of swing frequency upper/lower limit",
                    "15:Drive ready (RDY) 16:Drive fault 17:Switching signal of host 18:Reserved",
                    "19:Torque limiting",
                    "20:Drive running forward/reverse ",
                    "21~50:Reserved",
    ...
    public String[] GroupArray = new String[]{"User password", "Control mode", "Main reference \nfrequency selector","Methods of inputting \noperating commands",
            "User password", "Control mode", "Main reference \nfrequency selector","Methods of inputting \noperating commands"};
